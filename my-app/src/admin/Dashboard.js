...
import img_2 from './assets/images/dashboard/img_2.jpg';
import img_3 from './assets/images/dashboard/img_3.jpg';
import img_4 from './assets/images/dashboard/img_4.jpg';
...
function Dashboard() {
  ...
  const navigate = useNavigate();
    ...
    //setAuthenticated(authentic);
    console.log("before", authentic);
    if(authentic == "false" || authentic == null) {
      navigate('/login');
    } 
	},[]);
              ...
              <div className="col-md-4 stretch-card grid-margin">
                <div className="card bg-gradient-danger card-img-holder text-white">
                  <div className="card-body">
                    <img src={OverviewLogo} className="card-img-absolute" alt="circle-image" />
                    ...
                    <div className="table-responsive">
                      <table className="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src={face1} className="me-2" alt="image" /> David Grey
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src={face2} className="me-2" alt="image" /> Stella Johnson
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src={face3} className="me-2" alt="image" /> Marina Michel
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src={face4} className="me-2" alt="image" /> John Doe
                            </td>
                  ...
                  <div className="card-body">
                    ...
                    <div className="row mt-3">
                      <div className="col-6 pe-1">
                        ...
                        <img src={img_4} className="mw-100 w-100 rounded" alt="image" />
                      </div>
                      <div className="col-6 ps-1">
                        <img src={img_2} className="mb-2 mw-100 w-100 rounded" alt="image" />
                        <img src={img_3} className="mw-100 w-100 rounded" alt="image" />
                      </div>
                    </div>
                    <div className="d-flex mt-5 align-items-top">
                      <img src={face3} className="img-sm rounded-circle me-3" alt="image" />
